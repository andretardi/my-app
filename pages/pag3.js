...
export default function Home() {
  return (
    <Layout>
      ...
      <img src="img/pag3.png" width="100%" height="100%" />

      <br />
      <br />
      <Text titolo="IMMERSIVO" testo="Imergiti in una realtà mista per due ore di tranquillità giocando o lavorando"></Text>
      <br />

      <Grid container spacing={1}>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag31.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag32.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
      </Grid>
      ...
      <br />
      <Text titolo="REALTA' MISTA" testo="grazie alle telecamere spaziali si risce ad avere una realtaà mista fenomenale"></Text>
      <br />
