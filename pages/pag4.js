...
export default function Home() {
  return (
    <Layout>
      ...
      <img src="img/pag4.png" width="100%" height="100%" />

      <br />
      <br />
      <Text Text titolo="IMMERSIVO" testo="Imergiti in una realtà mista per due ore di tranquillità giocando o lavorando"></Text>
      <br />

      <Grid container spacing={1}>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag41.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag42.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
      </Grid>
      ...
      <br />
      <Text titolo="COMODITA'" testo="il meta pro è stato progettato per lavorare o giocare in comodità e con la massima potenza"></Text>
      <br />
