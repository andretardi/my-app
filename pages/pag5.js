...
export default function Home() {
  return (
    <Layout>
      ...
      <img src="img/pag5.png" width="100%" height="100%" />

      <br />
      <br />
      <Text titolo="COMODITA'" testo="se giochi tanto con i visori questo cinturino è adatto a te"></Text>
      <br />

      <Grid container spacing={1}>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag51.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
        <Grid item lg={6} xs={12}>
          <MediaCard
            immagine="/img/pag52.png"
            link="https://www.meta.com/it-it/experiences/"
          />
        </Grid>
      </Grid>
      ...
      <br />
      <Text titolo="BATTERIA" testo="il cinturino ha la versine con una batteria aggiuntiva per piu ore di gioco"></Text>
      <br />
